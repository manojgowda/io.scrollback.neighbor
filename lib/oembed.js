const oEmbedProviders = [
    ...
    [ /https?:\/\/(www\.)?collegehumor\.com\/video\S+/i, " http://www.collegehumor.com/oembed.json"],
    [ /https?:\/\/(www\.)?ted\.com\/talks\S+/i, "http://www.ted.com/talks/oembed.json"]
];

export default function(link) {
    for (let i = 0, l = oEmbedProviders.length; i < l; i++) {
        let provider = oEmbedProviders[i];
